...
class Postgres_DB:
    ...
    # @staticmethod
    # def insert(session: Session, obj: Base, pk_constraint: bool = True, fk_constraint: bool = True) -> (bool, dict):
    #     try:
    #         # session.begin()
    ...
    # @staticmethod
    # def delete(session: Session, obj: Base, fk_constraint: bool = True, soft_delete = False) -> (bool, dict):
    #     try:
    #         # session.begin()
    #         if fk_constraint:
